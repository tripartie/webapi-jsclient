...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripartieWebAPI.ModelUser();
  });
  ...
  describe('ModelUser', function() {
    it('should create an instance of ModelUser', function() {
      ...
      //var instane = new TripartieWebAPI.ModelUser();
      //expect(instance).to.be.a(TripartieWebAPI.ModelUser);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TripartieWebAPI.ModelUser();
