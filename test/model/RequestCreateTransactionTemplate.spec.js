...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripartieWebAPI.RequestCreateTransactionTemplate();
  });
  ...
  describe('RequestCreateTransactionTemplate', function() {
    it('should create an instance of RequestCreateTransactionTemplate', function() {
      // uncomment below and update the code to test RequestCreateTransactionTemplate
      //var instane = new TripartieWebAPI.RequestCreateTransactionTemplate();
      //expect(instance).to.be.a(TripartieWebAPI.RequestCreateTransactionTemplate);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new TripartieWebAPI.RequestCreateTransactionTemplate();
